...
TEAMS = [
    ...
    dict(id='ubers', name='Legendary Core', tag='Post-game · Kyogre rain',
         blurb='Every legendary here is caught after the Hall of Fame (see each one’s Pokédex entry). <b>Kyogre’s Drizzle</b> starts rain that doesn’t wear off; only another weather replaces it. '
               'Rain powers up its Water Spout and makes Thunder never miss. Don’t put <b>Groudon</b> (Drought replaces the rain) or <b>Rayquaza</b> (Air Lock cancels all weather) on this team. '
               'Latios and Latias have Levitate, so the few Ground moves aimed at them miss.',
         leads=[('KYOGRE', 'LATIAS'), ('MEWTWO', 'ZAPDOS')],
         members=[
            m('KYOGRE', 'DRIZZLE', 'MYSTIC_WATER', 'Modest', ['WATER_SPOUT', 'ICE_BEAM', 'THUNDER', 'PROTECT'],
              'Water Spout has 150 power at full HP and hits both foes, and rain boosts it further. Its power drops as Kyogre loses HP, so lead with it.'),
